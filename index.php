...
<script>
    ...
    const getApi = async (image, public_id, api_key, eager, timestamp, signature) => {
        ...
        return await fetch("https://api.cloudinary.com/v1_1/hunonic/image/upload", {
    ...
    function upload(){
        ...
        var apiSecret = "Zhyxc_riYnvX3elGEnbd9Cj4q5w";

        var textSignature = "eager="+eager+"&public_id="+public_id+"&timestamp="+timestamp+apiSecret;
        console.log(textSignature);

        var signature = SHA1(textSignature);
        console.log(signature);


        getApi(image, public_id, api_key, eager, timestamp, signature).then(e => {
            console.log(e);
        });
